...
export const MEDIA_GALLERY: MediaItem[] = [
  {
    ...
    type: 'video',
    category: 'live',
    title: 'Live From Tahuin Sport Ecolodge, Arenillas - Ecuador',
  ...
  },
  {
    ...
    type: 'video',
    category: 'official',
    title: 'EHDU B2B Ruvio DJ Set Live at Block Party Machala',
    description: 'Live at Block Party Machala',
